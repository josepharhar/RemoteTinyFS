...
public class CredentialsObfuscator {
   ...
   */
  public byte[] obfuscateAccessCredentials(
      final AccessCredentials accessCredentials) {
    return obfuscateProtobufCredentials(
      () -> accessCredentials.toByteArray());
  }
   ...
   */
  public AccessCredentials deobfuscateEncryptedAccessCredentials(
      final byte[] obfuscatedCredentials) {
    return deobfuscateProtobufCredentials(
      obfuscatedCredentials,
      (credentials) -> AccessCredentials.parseFrom(credentials));
  }
